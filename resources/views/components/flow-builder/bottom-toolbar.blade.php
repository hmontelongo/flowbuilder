...
<div class="absolute bottom-[17px] left-1/2 -translate-x-1/2 flex gap-[8px] items-center z-10">
    ...
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Variable" @click="$dispatch('add-block', { type: 'variable' })">
    ...
    {{-- Events --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Eventos" @click="$dispatch('add-block', { type: 'events' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
    ...
    {{-- Data--categorical --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Datos" @click="$dispatch('add-block', { type: 'data' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
