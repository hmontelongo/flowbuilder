...
<div class="absolute left-[23px] top-[135px] flex flex-col gap-[8px] items-start justify-center z-10">
    ...
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Trigger" @click="$dispatch('add-block', { type: 'trigger' })">
    ...
    {{-- Chat (Message) --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Mensaje" @click="$dispatch('add-block', { type: 'message' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
    ...
    {{-- List--numbered (Menu) --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Menú" @click="$dispatch('add-block', { type: 'menu' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
    ...
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Transferir" @click="$dispatch('add-block', { type: 'transfer' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
    ...
    {{-- API (text) --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="API" @click="$dispatch('add-block', { type: 'api' })">
    ...
    {{-- AI (text) --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="AI" @click="$dispatch('add-block', { type: 'ai' })">
    ...
    {{-- Flag --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Bandera" @click="$dispatch('add-block', { type: 'flag' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
...
<div class="absolute left-[25px] top-[399px] flex flex-col gap-[8px] items-start justify-center z-10">
    ...
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Esperar" @click="$dispatch('add-block', { type: 'wait' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
    ...
    {{-- Knowledge catalog --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Conocimiento" @click="$dispatch('add-block', { type: 'knowledge' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
    ...
    {{-- Condition--point --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Condición" @click="$dispatch('add-block', { type: 'condition' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
    ...
    {{-- Timer --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Temporizador" @click="$dispatch('add-block', { type: 'timer' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
    ...
    {{-- Repeat --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Repetir" @click="$dispatch('add-block', { type: 'repeat' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
    ...
    {{-- Reset--alt --}}
    <div class="bg-white flex items-center overflow-clip rounded-[8px]">
        <button type="button" class="flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] rounded-[8px] hover:bg-[#f3f4f6]" title="Reiniciar" @click="$dispatch('add-block', { type: 'reset' })">
            <div class="overflow-clip relative size-[16px]">
                <svg class="size-full" viewBox="0 0 16 16" fill="none">
